...
export const useGlobalStore = create<GlobalState>((set) => ({
    ...
    fetchUserInfo: async () => {
        ...
        try {
            ...
            set({ preferences: data.preferences, settings: data.settings, profile: data.profile, favorites: data.favorites, error: null });
        } catch (error) {
    ...
    updateProfile: async (updates: UpdateProfileRequest) => {
        ...
        try {
            ...
            const data = await response.json();
            set((state) => ({
                preferences: state.preferences ? { ...state.preferences, profile: data } : null,
                error: null,
            }));
        } catch (error) {
    ...
    updatePreferences: async (updates: UpdatePreferencesRequest) => {
        ...
        try {
            ...
            const data = await response.json();
            set((state) => ({
                preferences: state.preferences ? { ...state.preferences, preferences: data } : null,
                error: null,
            }));
        } catch (error) {
    ...
    setPreferences: (preferences: DietaryPreferences) => {
